/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 217852d49ddd602383407deaf469d8f8)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		DATABASE_URL: string;
		WORKER_SELF_REFERENCE: Fetcher /* eduhub */;
	}
}
